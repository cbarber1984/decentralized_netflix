...
const Home = () => {
  ...
  useEffect(() => {
    ...
    async function fetchMyList() {
      await Moralis.start({ serverUrl: "https://giczzoedplwi.usemoralis.com:2053/server", appId: "dKS8tQFnzXqTjoKQiAvdZvULJDjeJbXlF7tKmYyO" })
          ...
          <div className="modal">
            ...
            >
              <div className="modalContent">
                <img src={selectedFilm.Scene} className="sceneImg"></img>
